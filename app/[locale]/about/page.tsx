      ...
      <section className="relative w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4 bg-gradient-to-br from-white to-gray-50 overflow-hidden flex flex-col items-center"> {/* py- 값 조정 */}
        ...
        <div className="w-full relative z-0 py-6 bg-gray-200 text-center"> 
            ...
            <div className="overflow-hidden"> {/* 애니메이션을 위한 클리핑 컨테이너 */}
                {/* w-max를 사용하여 콘텐츠 너비에 맞게 늘어나도록 함 */}
                <div className="flex flex-nowrap animate-scroll-left w-max items-center"> {/* 이미지 세로 정렬을 중앙으로 변경 */}
                    {/* 첫 번째 이미지 세트 */}
      ...
      <section className="w-full py-2 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            {/* Next.js Image 컴포넌트는 이미지 최적화에 유리합니다. */}
            <Image
              src="/images/about_story_hero.jpg" // 이 이미지의 확장자가 .jpg라면 이대로 유지
